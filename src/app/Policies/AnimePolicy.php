...
class AnimePolicy
{
    ...
    {
        return $user->can('view_any_anime');
    }
    ...
    {
        return $user->can('delete_any_anime');
    }
     ...
     */
    public function replicate(User $user, Anime $anime): bool
    {
